package com.dev.foodappchallengebinar.presentation.common.adapter
...
import com.dev.foodappchallengebinar.databinding.ItemCartMenuBinding
import com.dev.foodappchallengebinar.databinding.ItemCartMenuOrderBinding
import com.dev.foodappchallengebinar.utils.doneEditing
...
class CartViewHolder(
    private val binding: ItemCartMenuBinding, private val cartListener: CartListener?
    ...
    private fun setCartData(item: Cart) {
        with(binding) {
            ...
            tvTotalQuantity.text = itemView.rootView.context.getString(
                R.string.total_quantity, item.itemQuantity.toString()
            )
            tvMenuName.text = item.menuName
            tvMenuPrice.text = (item.itemQuantity * item.menuPrice).toIndonesianFormat()
        }
