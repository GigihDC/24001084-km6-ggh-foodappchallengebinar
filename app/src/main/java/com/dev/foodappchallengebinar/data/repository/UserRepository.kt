...
interface UserRepository {
    ...
    fun updateProfile(fullName: String? = null, photoUri: Uri? = null): Flow<ResultWrapper<Boolean>>
...
class UserRepositoryImpl(private val dataSource: AuthDataSource) : UserRepository {
    ...
    override fun updateProfile(fullName: String?, photoUri: Uri?): Flow<ResultWrapper<Boolean>> {
